...
<div align="center">
  <img src="public/screenshots/hero.png" alt="OCHI Hero Preview" width="100%" style="border-radius: 12px; box-shadow: 0 20px 40px rgba(0,0,0,0.3);" />
  ...
  <table>
    <tr>
      <td width="50%">
        ...
        <img src="public/screenshots/eyes.png" alt="WASM Eyes Tracking" width="100%" style="border-radius: 8px;" />
      </td>
      <td width="50%">
        <h4 align="center">💼 Apple-Physics Project Cards</h4>
        <img src="public/screenshots/projects.png" alt="Project Cards Preview" width="100%" style="border-radius: 8px;" />
      </td>
    </tr>
    <tr>
      <td colspan="2" width="100%">
        <h4 align="center">✨ RabbidCoding Signature Watermark & Footer</h4>
        <img src="public/screenshots/footer.png" alt="Footer Watermark Preview" width="100%" style="border-radius: 8px;" />
      </td>
    </tr>
  </table>
</div>
